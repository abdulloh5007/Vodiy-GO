...
export type Message = {
    id: string;
    type: 'REGISTRATION_PENDING' | 'REGISTRATION_APPROVED' | 'REGISTRATION_REJECTED' | 'REGISTRATION_BLOCKED' | 'REGISTRATION_UNBLOCKED' | 'RIDE_CREATED' | 'RIDE_APPROVED' | 'RIDE_REJECTED' | 'RIDE_BLOCKED' | 'BOOKING_ACCEPTED' | 'BOOKING_REJECTED';
    titleKey: string;
    bodyKey: string;
